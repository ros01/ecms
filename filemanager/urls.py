...
urlpatterns = [
    ...
    path("f/<slug:slug>/", views.FolderDetail.as_view(), name="folder_detail"),
    ...
    path("f/upload_document/", views.DocumentCreate.as_view(), name="document_create"),
    # path("f/upload_document/", views.document_create , name="document_create"),
